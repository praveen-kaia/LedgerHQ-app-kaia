...
#            chain_code_len (1)
#            chain_code (var)
def unpack_get_public_key_response(response: bytes) -> Tuple[int, bytes, int, bytes, int, bytes]:
    ...
    return pub_key_len, pub_key, address_len, address, chain_code_len, chain_code
